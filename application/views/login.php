                ...
                <div class="col-sm-12 col-md-10  col-md-offset-1 ">
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input class="form-control" placeholder="Usuario" name="usuario" type="text" autofocus required pattern="[A-Za-z0-9-_@]{1,20}">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input class="form-control" placeholder="Contraseña" name="pass" type="password" required pattern="[A-Za-z0-9-_@]{1,20}">
                    </div>
                  </div>
                  <div class="form-group">
